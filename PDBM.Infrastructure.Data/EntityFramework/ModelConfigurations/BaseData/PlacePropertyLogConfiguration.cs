...
{
    /// <summary>
    /// tbl_PlacePropertyLog表配置
    /// </summary>
    internal class PlacePropertyLogConfiguration : EntityTypeConfiguration<PlacePropertyLog>
    {
        public PlacePropertyLogConfiguration()
        {
            ToTable("tbl_PlacePropertyLog");
            HasKey<Guid>(e => e.Id);
