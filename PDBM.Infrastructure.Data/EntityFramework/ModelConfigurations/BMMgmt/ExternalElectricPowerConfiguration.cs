...
{
    /// <summary>
    /// ExternalElectricPower表配置
    /// </summary>
    internal class ExternalElectricPowerConfiguration : EntityTypeConfiguration<ExternalElectricPower>
    {
        public ExternalElectricPowerConfiguration()
        {
            ToTable("tbl_ExternalElectricPower");
            HasKey<Guid>(e => e.Id);
