...
namespace PDBM.Infrastructure.Data.EntityFramework.ModelConfigurations.BMMgmt
{
    ...
    /// TowerLog表配置
    /// </summary>
    internal class TowerLogConfiguration : EntityTypeConfiguration<TowerLog>
    {
        public TowerLogConfiguration()
        {
            ToTable("tbl_TowerLog");
            HasKey<Guid>(e => e.Id);
            ...
            Property(e => e.TowerType)
                .IsRequired();
            Property(e => e.TowerHeight)
                .IsRequired()
                .HasPrecision(18, 2);
            Property(e => e.PlatFormNumber)
                .IsRequired();
