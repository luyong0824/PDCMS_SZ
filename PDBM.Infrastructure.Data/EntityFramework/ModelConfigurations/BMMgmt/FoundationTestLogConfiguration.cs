...
{
    /// <summary>
    /// FoundationTestLog表配置
    /// </summary>
    internal class FoundationTestLogConfiguration : EntityTypeConfiguration<FoundationTestLog>
    {
        public FoundationTestLogConfiguration()
        {
            ToTable("tbl_FoundationTestLog");
            HasKey<Guid>(e => e.Id);
