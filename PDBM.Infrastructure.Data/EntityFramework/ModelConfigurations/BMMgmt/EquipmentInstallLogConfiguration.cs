...
{
    /// <summary>
    /// EquipmentInstallLog表配置
    /// </summary>
    internal class EquipmentInstallLogConfiguration : EntityTypeConfiguration<EquipmentInstallLog>
    {
        public EquipmentInstallLogConfiguration()
        {
            ToTable("tbl_EquipmentInstallLog");
            HasKey<Guid>(e => e.Id);
