...
namespace PDBM.Domain.Models.BMMgmt
{
    ...
    /// 铁塔基础实体
    /// </summary>
    public class TowerBase : AggregateRoot
    {
        protected TowerBase()
        {
        }
        ...
        /// <param name="towerBaseType">铁塔基础类型</param>
        /// <param name="createUserId">创建人用户Id</param>
        internal TowerBase(Guid parentId, PropertyType propertyType, TowerBaseType towerBaseType, decimal budgetPrice, int timeLimit, string memos, Guid createUserId)
        {
        ...
        public void Modify(TowerBaseType towerBaseType, decimal budgetPrice, int timeLimit, string memos, Guid modifyUserId)
        {
            towerBaseType.IsInvalid("铁塔基础类型");
