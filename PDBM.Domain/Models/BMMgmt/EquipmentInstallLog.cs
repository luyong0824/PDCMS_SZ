...
namespace PDBM.Domain.Models.BMMgmt
{
    ...
    /// 设备安装历史记录实体
    /// </summary>
    public class EquipmentInstallLog : AggregateRoot
    {
        protected EquipmentInstallLog()
        {
        }
        ...
        internal EquipmentInstallLog(OperationType operationType, Guid parentId, PropertyType propertyType, decimal switchPower, decimal battery, int cabinetNumber, decimal budgetPrice, int timeLimit, string memos, Guid createUserId)
        {
