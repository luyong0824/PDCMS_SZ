...
namespace PDBM.Domain.Models.BMMgmt
{
    ...
    /// 地质勘探历史记录实体
    /// </summary>
    public class AddressExplorLog : AggregateRoot
    {
        protected AddressExplorLog()
        {
        }
        ...
        internal AddressExplorLog(OperationType operationType, Guid parentId, PropertyType propertyType, decimal budgetPrice, int timeLimit, string memos, Guid createUserId)
        {
