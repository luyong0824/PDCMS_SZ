...
namespace PDBM.Domain.Models.BMMgmt
{
    ...
    /// 桩基动测实体
    /// </summary>
    public class FoundationTest : AggregateRoot
    {
        protected FoundationTest()
        {
        }
        ...
        internal FoundationTest(Guid parentId, PropertyType propertyType, decimal budgetPrice, int timeLimit, string memos, Guid createUserId)
        {
