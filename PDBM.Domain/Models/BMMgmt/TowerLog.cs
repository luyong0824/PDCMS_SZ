...
namespace PDBM.Domain.Models.BMMgmt
{
    ...
    /// 铁塔历史记录实体
    /// </summary>
    public class TowerLog : AggregateRoot
    {
        protected TowerLog()
        {
        }
        ...
        internal TowerLog(OperationType operationType, Guid parentId, PropertyType propertyType, TowerType towerType, decimal towerHeight, int platFormNumber, int poleNumber, decimal budgetPrice, int timeLimit, string memos, Guid createUserId)
        {
