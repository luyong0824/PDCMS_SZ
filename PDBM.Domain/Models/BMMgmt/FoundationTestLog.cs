...
namespace PDBM.Domain.Models.BMMgmt
{
    ...
    /// 桩基动测历史记录实体
    /// </summary>
    public class FoundationTestLog : AggregateRoot
    {
        protected FoundationTestLog()
        {
        }
        ...
        internal FoundationTestLog(OperationType operationType, Guid parentId, PropertyType propertyType, decimal budgetPrice, int timeLimit, string memos, Guid createUserId)
        {
